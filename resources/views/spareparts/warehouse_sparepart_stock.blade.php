...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <div class="mb-3 row">
                <label for="name" class="col-md-3 col-form-label text-md-end text-start">Warehouse</label>
                <div class="col-md-7">
            ...
            @if($locationId>0)
            <a href="/stock-warehouse-spareparts/export-excel?locationId={{$locationId}}" class="btn btn-warning btn-sm"><i class="bi bi-eye"></i> Export Excel</a>
            @endif
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td align="center">
                                    ...
                                    <a href="{{ route('warehouseSparepartStock')}}?locationId={{$locationId}}&sparepartId={{$rowData->sparepartId}}" class="btn btn-warning btn-sm"><i class="bi bi-eye"></i> Detail</a>
